...
c.pushComputed('express.static', () => ({
  route: '/system/plugin-babel',
  path: config.views.system.paths.systemjsBabel
}));
// route for systemJS package loader plugin
// c.pushComputed('express.static', () => ({
//   route: '/system/package-loader-plugin.js',
//   path: config.views.system.paths.packageLoader,
//   file: true
// }));
// route for systemJS main application script
c.pushComputed('express.static', () => ({
  route: '/system/main.js',
  path: config.views.system.paths.main,
  file: true
}));
// path to import all module
cc('views.system.paths.importAll', () => path.join(
  config.paths.cache, 'bedrock-views', 'importAll.js'));
// route for import all module
c.pushComputed('express.static', () => ({
  route: '/system/importAll.js',
