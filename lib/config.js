...
config.views.less.compile.out = 'bedrock-views.css';

// css config
config.views.css = {};
config.views.css.optimize = {};
config.views.css.optimize.options = {};
config.views.css.optimize.out = 'bedrock-views.min.css';
...
config.views.angular.optimize.templates.out = 'bedrock-angular-templates.js';
// htmlmin options
