...
config.views.main = {
  ...
  file: {
    path: path.join(__dirname, '..', 'views', 'main.html'),
    options: null
  },
  // render view with vars if set (checked second)
  render: {
    view: null,
    vars: null
  }
...
// frontend error HTML config
config.views.error = {
  // send file with options if set (checked first)
  file: {
    path: path.join(__dirname, '..', 'views', 'error.html'),
    options: null
  },
  // render view with vars if set (checked second)
  render: {
