...
// optimize config
config.views.optimize = {};

// angular optimization config
config.views.optimize.angular = {};
config.views.optimize.angular.templates = {};
// custom package configurations
config.views.optimize.angular.templates.packages = {};
...
config.views.optimize.angular.templates.src = [
  '**/*.html',
  '!node_modules/**',
  '!bower_components'
];
...
config.views.optimize.angular.templates.ignore = {};
config.views.optimize.angular.templates.ignore.packages = ['forge'];
config.views.optimize.angular.templates.ignore.files = [];
