...
bedrock.events.on('bedrock-cli.ready', function(callback) {
  ...
  if(bedrock.config.cli.command.name === 'optimize') {
    return bedrock.runOnce('bedrock-views.optimize', function(callback) {
      // TODO: implement CSS optimization
      // TODO: only do JS-only optimization w/`--js` option, otherwise
      // do both
...
// TODO: add bedrock.config.express.static entries for css, optimized
// bedrock.templates
